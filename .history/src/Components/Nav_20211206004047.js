      ...
      <nav className="nav">
        <div className="navLogoText">
          ...
          <ul className={`${active ? "activenav" : ""}`}>
            ...
            <li>Contact Us</li>
            <li className="optbtn">
              <button className="navButtons__signInss">Sign In</button>
            </li>
            <li className="optbtn">
              <button className="navButtons__signIns">
                Create New Account
              </button>
            </li>
          </ul>
